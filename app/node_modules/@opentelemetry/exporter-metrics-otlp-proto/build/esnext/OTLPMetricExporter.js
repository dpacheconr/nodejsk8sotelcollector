...
class OTLPMetricExporterNodeProxy extends OTLPProtoExporterNodeBase {
    constructor(config) {
        super(config);
        this.headers = Object.assign(Object.assign(Object.assign(Object.assign({}, this.headers), USER_AGENT), baggageUtils.parseKeyPairsIntoRecord(getEnv().OTEL_EXPORTER_OTLP_METRICS_HEADERS)), config === null || config === void 0 ? void 0 : config.headers);
    }
    convert(metrics) {
