...
class OTLPMetricExporterNodeProxy extends otlp_proto_exporter_base_1.OTLPProtoExporterNodeBase {
    constructor(config) {
        super(config);
        this.headers = Object.assign(Object.assign(Object.assign(Object.assign({}, this.headers), USER_AGENT), core_1.baggageUtils.parseKeyPairsIntoRecord((0, core_1.getEnv)().OTEL_EXPORTER_OTLP_METRICS_HEADERS)), config === null || config === void 0 ? void 0 : config.headers);
    }
    convert(metrics) {
    ...
    getServiceClientType() {
        return otlp_proto_exporter_base_1.ServiceClientType.METRICS;
    }
}
